create type "public"."asset_types" as enum ('Cash', 'Stocks', 'Bonds', 'Real Estate', 'Mutual Funds', 'Retirement Account', 'Crypto', 'Life Insurance');
...
alter table "public"."asset_beneficiaries" add constraint "public_assetBeneficiaries_beneficaryId_fkey" FOREIGN KEY (beneficiary_id) REFERENCES beneficiaries(id) ON DELETE CASCADE not valid;

alter table "public"."asset_beneficiaries" validate constraint "public_assetBeneficiaries_beneficaryId_fkey";

alter table "public"."assets" add constraint "public_assets_client_id_fkey" FOREIGN KEY (client_id) REFERENCES clients(id) not valid;

alter table "public"."assets" validate constraint "public_assets_client_id_fkey";

alter table "public"."beneficiaries" add constraint "public_beneficiaries_client_id_fkey" FOREIGN KEY (client_id) REFERENCES clients(id) not valid;

alter table "public"."beneficiaries" validate constraint "public_beneficiaries_client_id_fkey";

alter table "public"."businesses" add constraint "public_businesses_client_id_fkey" FOREIGN KEY (client_id) REFERENCES clients(id) not valid;

alter table "public"."businesses" validate constraint "public_businesses_client_id_fkey";

alter table "public"."clients" add constraint "public_clients_agent_id_fkey" FOREIGN KEY (agent_id) REFERENCES agents(id) not valid;

alter table "public"."clients" validate constraint "public_clients_agent_id_fkey";

alter table "public"."debts" add constraint "public_debts_client_id_fkey" FOREIGN KEY (client_id) REFERENCES clients(id) not valid;

alter table "public"."debts" validate constraint "public_debts_client_id_fkey";

alter table "public"."goals" add constraint "public_goals_client_id_fkey" FOREIGN KEY (client_id) REFERENCES clients(id) not valid;

alter table "public"."goals" validate constraint "public_goals_client_id_fkey";
